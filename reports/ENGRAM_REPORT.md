...
We use the InferSim FLOPs-based approach consistent with our existing InferLens framework:
...
*Generated by the Engram simulation experiment (`experiments/run_engram_experiment.py`) using the extended InferLens/InferSim framework.*
