...
**Full experiment runner:** `python experiments/run_experiments.py`

## Appendix B: Generated Figures

All figures in this report are generated by `experiments/generate_report_figures.py` and stored in `../report_figures/`.
